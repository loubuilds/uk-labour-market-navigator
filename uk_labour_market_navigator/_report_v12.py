...
def render(plan, evidence, draft):
    ...
    html = [
        ...
        + "</p>",
        '<p class="small">Source figures are checked against official data. The AI-written interpretation and suggested next steps need your judgement.</p></header>',
    ]
    md = [
        "# " + md_text(draft["title"]),
        "**" + PRODUCT_NAME + "**",
        ...
        "Source figures are checked against official data. The AI-written interpretation and suggested next steps need your judgement.",
    ]
