...
def render(plan, evidence, draft):
    ...
    footer = "This is a saved report based on the dates shown above. To check it again, ask your coding assistant to verify this report. That checks the saved evidence; it does not fetch newer data."
