    ...
    if p.get("status") != "not_requested":
        ...
        if p["facts"]:
            ...
            note = (
                ...
                + ". All sexes; workplace basis; 2025 provisional, with the December correction retained. Percentiles describe the pay distribution, not a recommended offer range. CV measures sampling precision, not certainty about a particular salary."
            )
